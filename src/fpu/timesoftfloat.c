...
/**
	...
	@brief implemments a softfloat benchmark
*/
...
static void time_a_int32_z_float32( float32 function( int32 ,unsigned *) )
{
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_int32[ inputNum ] ,&flags);
...
static void time_a_int64_z_float32( float32 function( int64 , unsigned * ) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_int64[ inputNum ] ,&flags);
...
static void time_a_int64_z_float64( float64 function( int64 ,unsigned * ) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_a_float32_z_int32( int32 function( float32 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_float32[ inputNum ] ,&flags);
...
static void time_a_float32_z_int64( int64 function( float32 ,unsigned * ) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_a_float32_z_float64( float64 function( float32 ,unsigned * ) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_az_float32( float32 function( float32 ,unsigned * ) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_ab_float32_z_flag( flag function( float32, float32 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function(
                inputs_float32[ inputNumA ], inputs_float32[ inputNumB ] ,&flags);
...
static void time_abz_float32( float32 function( float32, float32 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNumA, inputNumB;
...
static void time_az_float32_pos( float32 function( float32 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_float32_pos[ inputNum ] ,&flags);
            inputNum = ( inputNum + 1 ) & ( numInputs_float32 - 1 );
        }
        count += minIterations;
    } while ( clock() - startClock < CLOCKS_PER_SEC );
...
static void time_a_float64_z_int32( int32 function( float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_float64[ inputNum ] ,&flags);
...
static void time_a_float64_z_int64( int64 function( float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_a_float64_z_float32( float32 function( float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_az_float64( float64 function( float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
...
static void time_ab_float64_z_flag( flag function( float64, float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNumA, inputNumB;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function(
                inputs_float64[ inputNumA ], inputs_float64[ inputNumB ] ,&flags);
...
static void time_abz_float64( float64 function( float64, float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNumA, inputNumB;
...
static void time_az_float64_pos( float64 function( float64 ,unsigned *) )
{
    clock_t startClock, endClock;
    int32 count, i;
    int8 inputNum;
    ...
    do {
        for ( i = minIterations; i; --i ) {
            function( inputs_float64_pos[ inputNum ] ,&flags);
            inputNum = ( inputNum + 1 ) & ( numInputs_float64 - 1 );
        }
        count += minIterations;
    } while ( clock() - startClock < CLOCKS_PER_SEC );
