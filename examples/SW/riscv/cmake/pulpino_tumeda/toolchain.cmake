...
IF(WIN32)
    set(RISCV_ELF_GCC_PREFIX "D:\\a\\" CACHE PATH "install location for riscv-gcc toolchain")
    ...
    set(CMAKE_C_COMPILER ${RISCV_ELF_GCC_PREFIX}riscv-tc/${RISCV_ELF_GCC_BASENAME}-gcc${EXE_EXT})
    MESSAGE("C Compiler: ${CMAKE_C_COMPILER}")
    set(CMAKE_CXX_COMPILER ${RISCV_ELF_GCC_PREFIX}riscv-tc/${RISCV_ELF_GCC_BASENAME}-g++${EXE_EXT})
    MESSAGE("CXX Compiler: ${CMAKE_CXX_COMPILER}")
    set(CMAKE_OBJCOPY ${RISCV_ELF_GCC_PREFIX}riscv-tc/${RISCV_ELF_GCC_BASENAME}-objcopy${EXE_EXT})
