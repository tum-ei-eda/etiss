...
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[2U], 32);
		cp.getAffectedRegisters().add(reg_name[rd + 8U], 32);
...
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rs1 + 8U], 32);
		cp.getAffectedRegisters().add(reg_name[rd + 8U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
	{
...
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rs1 + 8U], 32);
		cp.getRegisterDependencies().add(reg_name[rs2 + 8U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
	{
		CodePart & cp = cs.append(CodePart::APPENDEDRETURNINGREQUIRED);
...
// -----------------------------------------------------------------------------
		...
		cp.getAffectedRegisters().add(reg_name[rs1 % 32U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
...
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getAffectedRegisters().add(reg_name[1U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
	{
		CodePart & cp = cs.append(CodePart::APPENDEDRETURNINGREQUIRED);
...
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[2U], 32);
		cp.getAffectedRegisters().add(reg_name[2U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
	{
		CodePart & cp = cs.append(CodePart::APPENDEDRETURNINGREQUIRED);
...
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rs1 + 8U], 32);
		cp.getAffectedRegisters().add(reg_name[rs1 + 8U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
...
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rd + 8U], 32);
		cp.getRegisterDependencies().add(reg_name[rs2 + 8U], 32);
		cp.getAffectedRegisters().add(reg_name[rd + 8U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
...
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rd % 32U], 32);
		cp.getRegisterDependencies().add(reg_name[rs2 % 32U], 32);
		cp.getAffectedRegisters().add(reg_name[rd % 32U], 32);
		cp.getAffectedRegisters().add("instructionPointer", 32);
	}
