...
{ // block
cp.code() += "etiss_coverage_count(1, 5279);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(2, 5261, 5260);\n";
...
cp.code() += "etiss_coverage_count(1, 5265);\n";
cp.code() += "((RV32IMACFD*)cpu)->RES_ADDR = offs;\n";
cp.code() += "etiss_coverage_count(3, 5268, 5266, 5267);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 5269);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int32)(res);\n";
cp.code() += "etiss_coverage_count(2, 5277, 5274);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 5314);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(2, 5286, 5285);\n";
cp.code() += "if (((RV32IMACFD*)cpu)->RES_ADDR == offs) { // conditional\n";
cp.code() += "etiss_coverage_count(3, 5289, 5287, 5288);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV32IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(2, 5298, 5292);\n";
...
cp.code() += "} // conditional\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 5300);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV32IMACFD*)cpu)->RES_ADDR != offs;\n";
cp.code() += "etiss_coverage_count(3, 5309, 5305, 5308);\n";
} // conditional
cp.code() += "((RV32IMACFD*)cpu)->RES_ADDR = -1LL;\n";
cp.code() += "etiss_coverage_count(2, 5313, 5311);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
