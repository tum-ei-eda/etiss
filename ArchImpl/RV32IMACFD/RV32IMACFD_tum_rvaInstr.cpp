...
cp.code() += "etiss_coverage_count(2, 5288, 5287);\n";
...
cp.code() += "etiss_coverage_count(1, 5292);\n";
cp.code() += "((RV32IMACFD*)cpu)->RES_ADDR = offs;\n";
cp.code() += "etiss_coverage_count(3, 5295, 5293, 5294);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 5296);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int32)(res);\n";
cp.code() += "etiss_coverage_count(2, 5304, 5301);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(2, 5313, 5312);\n";
cp.code() += "if (((RV32IMACFD*)cpu)->RES_ADDR == offs) { // conditional\n";
cp.code() += "etiss_coverage_count(3, 5316, 5314, 5315);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV32IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(2, 5325, 5319);\n";
...
cp.code() += "} // conditional\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 5327);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV32IMACFD*)cpu)->RES_ADDR != offs;\n";
cp.code() += "etiss_coverage_count(3, 5336, 5332, 5335);\n";
} // conditional
cp.code() += "((RV32IMACFD*)cpu)->RES_ADDR = -1LL;\n";
cp.code() += "etiss_coverage_count(2, 5340, 5338);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
