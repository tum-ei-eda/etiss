...
cp.code() += "etiss_coverage_count(5, 2705, 2702, 2700, 2703, 2704);\n";
{ // block
...
cp.code() += "etiss_coverage_count(12, 2724, 2723, 2714, 2712, 2711, 2710, 2708, 2722, 2720, 2719, 2718, 2716);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)(res);\n";
cp.code() += "etiss_coverage_count(6, 2733, 2729, 2728, 2726, 2732, 2730);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 2775);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 2736);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2742, 2739, 2737, 2740, 2741);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 2774);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_int64 res = (etiss_int64)((etiss_int32)(*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL])) * (etiss_int64)((etiss_int32)(*((RV32IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]));\n";
cp.code() += "etiss_coverage_count(12, 2761, 2760, 2751, 2749, 2748, 2747, 2745, 2759, 2757, 2756, 2755, 2753);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((res >> 32ULL));\n";
cp.code() += "etiss_coverage_count(8, 2773, 2766, 2765, 2763, 2772, 2769, 2767, 2770);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 2776);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2782, 2779, 2777, 2780, 2781);\n";
{ // block
...
cp.code() += "etiss_coverage_count(11, 2800, 2799, 2791, 2789, 2788, 2787, 2785, 2798, 2796, 2795, 2793);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((res >> 32ULL));\n";
cp.code() += "etiss_coverage_count(8, 2812, 2805, 2804, 2802, 2811, 2808, 2806, 2809);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2821, 2818, 2816, 2819, 2820);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 2851);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 2838, 2837, 2829, 2827, 2826, 2824, 2836, 2834, 2833, 2831);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((res >> 32ULL));\n";
cp.code() += "etiss_coverage_count(8, 2850, 2843, 2842, 2840, 2849, 2846, 2844, 2847);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
