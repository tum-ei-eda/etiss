...
cp.code() += "etiss_coverage_count(5, 2756, 2753, 2751, 2754, 2755);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2793, 2790, 2788, 2791, 2792);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2833, 2830, 2828, 2831, 2832);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 2872, 2869, 2867, 2870, 2871);\n";
{ // block
