...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int16 prod = (etiss_int32)((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (" + std::to_string(i) + "LL)) & ((1 << ((" + std::to_string(i + 7ULL) + "LL) - (" + std::to_string(i) + "LL) + 1)) - 1))) * (etiss_int32)((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (" + std::to_string(i) + "LL)) & ((1 << ((" + std::to_string(i + 7ULL) + "LL) - (" + std::to_string(i) + "LL) + 1)) - 1)));\n";
