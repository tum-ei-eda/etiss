...
cp.code() += "etiss_coverage_count(6, 5008, 5007, 5005, 5003, 5001, 5002);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5017, 5015, 5014, 5016);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 5054);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_coverage_count(7, 5041, 5040, 5036, 5035, 5033, 5039, 5037);\n";
cp.code() += "etiss_uint64 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint64)(((RV32IMACFD*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
cp.code() += "etiss_coverage_count(8, 5053, 5047, 5045, 5043, 5044, 5052, 5050, 5049);\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5112);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(14, 5075, 5074, 5060, 5058, 5057, 5065, 5063, 5062, 5070, 5068, 5067, 5071, 5073, 5072);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5084, 5082, 5081, 5083);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5099, 5098);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5111, 5100, 5110, 5104, 5101, 5105, 5108, 5106, 5109);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5170);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(14, 5133, 5132, 5118, 5116, 5115, 5123, 5121, 5120, 5128, 5126, 5125, 5129, 5131, 5130);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5142, 5140, 5139, 5141);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5157, 5156);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5169, 5158, 5168, 5162, 5159, 5163, 5166, 5164, 5167);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5228);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(14, 5191, 5190, 5176, 5174, 5173, 5181, 5179, 5178, 5186, 5184, 5183, 5187, 5189, 5188);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5200, 5198, 5197, 5199);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5215, 5214);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5227, 5216, 5226, 5220, 5217, 5221, 5224, 5222, 5225);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(14, 5249, 5248, 5234, 5232, 5231, 5239, 5237, 5236, 5244, 5242, 5241, 5245, 5247, 5246);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5258, 5256, 5255, 5257);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5273, 5272);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5285, 5274, 5284, 5278, 5275, 5279, 5282, 5280, 5283);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5338);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 5301, 5300, 5292, 5290, 5289, 5297, 5295, 5294, 5299, 5298);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5310, 5308, 5307, 5309);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5325, 5324);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5337, 5326, 5336, 5330, 5327, 5331, 5334, 5332, 5335);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5390);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 5353, 5352, 5344, 5342, 5341, 5349, 5347, 5346, 5351, 5350);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5362, 5360, 5359, 5361);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5377, 5376);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5389, 5378, 5388, 5382, 5379, 5383, 5386, 5384, 5387);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5442);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 5405, 5404, 5396, 5394, 5393, 5401, 5399, 5398, 5403, 5402);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5414, 5412, 5411, 5413);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5429, 5428);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5441, 5430, 5440, 5434, 5431, 5435, 5438, 5436, 5439);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5494);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 5457, 5456, 5448, 5446, 5445, 5453, 5451, 5450, 5455, 5454);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5466, 5464, 5463, 5465);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5481, 5480);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5493, 5482, 5492, 5486, 5483, 5487, 5490, 5488, 5491);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5541);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(7, 5504, 5503, 5500, 5498, 5497, 5502, 5501);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5513, 5511, 5510, 5512);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5528, 5527);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5540, 5529, 5539, 5533, 5530, 5534, 5537, 5535, 5538);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5578);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(12, 5556, 5555, 5548, 5545, 5544, 5546, 5547, 5554, 5551, 5550, 5552, 5553);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5565, 5563, 5562, 5564);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5616);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = (((~((((((RV32IMACFD*)cpu)->F[" + std::to_string(rs2) + "ULL]) >> (63ULL)) & 0x1ULL))) << 63) | (((((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL]) & 0x7fffffffffffffffULL)));\n";
cp.code() += "etiss_coverage_count(13, 5594, 5593, 5586, 5585, 5582, 5581, 5583, 5584, 5592, 5589, 5588, 5590, 5591);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5603, 5601, 5600, 5602);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5657);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 5635, 5634, 5622, 5620, 5619, 5632, 5627, 5625, 5624, 5633);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5644, 5642, 5641, 5643);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5708);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(9, 5671, 5670, 5663, 5661, 5660, 5668, 5666, 5665, 5669);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5680, 5678, 5677, 5679);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5695, 5694);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5707, 5696, 5706, 5700, 5697, 5701, 5704, 5702, 5705);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5759);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(9, 5722, 5721, 5714, 5712, 5711, 5719, 5717, 5716, 5720);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5731, 5729, 5728, 5730);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5746, 5745);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5758, 5747, 5757, 5751, 5748, 5752, 5755, 5753, 5756);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(5, 5766, 5765, 5763, 5762, 5764);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL + res;\n";
cp.code() += "etiss_coverage_count(5, 5777, 5769, 5768, 5776, 5775);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(6, 5786, 5785, 5783, 5782, 5781, 5784);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 5796);\n";
cp.code() += "{ // block\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 5795, 5793, 5792, 5794);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 5875);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = 0LL;\n";
cp.code() += "etiss_coverage_count(2, 5812, 5811);\n";
cp.code() += "res = fcmp_d(((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL], ((RV32IMACFD*)cpu)->F[" + std::to_string(rs2) + "ULL], 0LL);\n";
cp.code() += "etiss_coverage_count(8, 5826, 5817, 5825, 5820, 5819, 5823, 5822, 5824);\n";
cp.code() += "etiss_coverage_count(1, 5846);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 5852, 5849, 5847, 5850, 5851);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(5, 5859, 5857, 5856, 5854, 5858);\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5862, 5861);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5874, 5863, 5873, 5867, 5864, 5868, 5871, 5869, 5872);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 5941);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = 0LL;\n";
cp.code() += "etiss_coverage_count(2, 5878, 5877);\n";
cp.code() += "res = fcmp_d(((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL], ((RV32IMACFD*)cpu)->F[" + std::to_string(rs2) + "ULL], 2ULL);\n";
cp.code() += "etiss_coverage_count(8, 5892, 5883, 5891, 5886, 5885, 5889, 5888, 5890);\n";
cp.code() += "etiss_coverage_count(1, 5912);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 5918, 5915, 5913, 5916, 5917);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(5, 5925, 5923, 5922, 5920, 5924);\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5928, 5927);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 5940, 5929, 5939, 5933, 5930, 5934, 5937, 5935, 5938);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 6007);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = 0LL;\n";
cp.code() += "etiss_coverage_count(2, 5944, 5943);\n";
cp.code() += "res = fcmp_d(((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL], ((RV32IMACFD*)cpu)->F[" + std::to_string(rs2) + "ULL], 1ULL);\n";
cp.code() += "etiss_coverage_count(8, 5958, 5949, 5957, 5952, 5951, 5955, 5954, 5956);\n";
cp.code() += "etiss_coverage_count(1, 5978);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 5984, 5981, 5979, 5982, 5983);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(5, 5991, 5989, 5988, 5986, 5990);\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 5994, 5993);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 6006, 5995, 6005, 5999, 5996, 6000, 6003, 6001, 6004);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 6078);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 res = 0LL;\n";
cp.code() += "etiss_coverage_count(2, 6023, 6022);\n";
cp.code() += "res = fcvt_64_32(((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL], 0LL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "etiss_coverage_count(7, 6035, 6028, 6034, 6031, 6030, 6032, 6033);\n";
cp.code() += "etiss_coverage_count(1, 6049);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 6055, 6052, 6050, 6053, 6054);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(5, 6062, 6060, 6059, 6057, 6061);\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 6065, 6064);\n";
cp.code() += "((RV32IMACFD*)cpu)->FCSR = (((RV32IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 6077, 6066, 6076, 6070, 6067, 6071, 6074, 6072, 6075);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(2, 6081, 6080);\n";
cp.code() += "res = fcvt_64_32(((RV32IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL], 1ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "etiss_coverage_count(7, 6093, 6086, 6092, 6089, 6088, 6090, 6091);\n";
cp.code() += "etiss_coverage_count(1, 6107);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 6113, 6110, 6108, 6111, 6112);\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint64)((etiss_int32)(res));\n";
cp.code() += "etiss_coverage_count(7, 6123, 6118, 6117, 6115, 6122, 6120, 6119);\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 6172);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_int64 res = fcvt_32_64((etiss_uint32)(*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 2ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "etiss_coverage_count(8, 6150, 6149, 6146, 6145, 6144, 6142, 6147, 6148);\n";
cp.code() += "((RV32IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 6159, 6157, 6156, 6158);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
