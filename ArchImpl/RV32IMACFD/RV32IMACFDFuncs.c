...
return (*((RV32IMACFD*)cpu)->CSR[769ULL] >> (extension - 65ULL)) & 1ULL;
...
if ((RV32IMACFD_get_field(*((RV32IMACFD*)cpu)->CSR[384ULL], 2147483648ULL))) { // conditional
...
return *((RV32IMACFD*)cpu)->CSR[3ULL] & 31ULL;
...
return (*((RV32IMACFD*)cpu)->CSR[3ULL] >> 5ULL) & 7ULL;
...
return *((RV32IMACFD*)cpu)->CSR[768ULL] | 8589934592ULL | 34359738368ULL;
...
return (((1ULL) << 30) | (((*((RV32IMACFD*)cpu)->CSR[769ULL]) & 0x3fffffffULL)));
...
*((RV32IMACFD*)cpu)->CSR[3ULL] = (*((RV32IMACFD*)cpu)->CSR[3ULL] & 224ULL) | (val & 31ULL);
...
*((RV32IMACFD*)cpu)->CSR[3ULL] = ((val & 7ULL) << 5ULL) | (*((RV32IMACFD*)cpu)->CSR[3ULL] & 31ULL);
...
deleg = ((((RV32IMACFD*)cpu)->PRIV <= 1ULL)) ? (*((RV32IMACFD*)cpu)->CSR[771ULL]) : (0LL);
...
deleg = ((((RV32IMACFD*)cpu)->PRIV <= 1ULL)) ? (*((RV32IMACFD*)cpu)->CSR[770ULL]) : (0LL);
etiss_coverage_count(8, 762, 752, 761, 755, 753, 756, 759, 760);
} // block
} // conditional
etiss_coverage_count(1, 764);
if (((RV32IMACFD*)cpu)->PRIV <= 1ULL && (deleg >> bit) & 1ULL) { // conditional
etiss_coverage_count(9, 774, 767, 765, 773, 770, 768, 769, 771, 772);
{ // block
etiss_coverage_count(1, 851);
vector = ((*((RV32IMACFD*)cpu)->CSR[261ULL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
etiss_coverage_count(13, 789, 775, 788, 783, 780, 778, 779, 781, 782, 786, 784, 785, 787);
cpu->nextPc = (*((RV32IMACFD*)cpu)->CSR[261ULL] & -2LL) + vector;
etiss_coverage_count(7, 802, 790, 801, 798, 793, 799, 800);
*((RV32IMACFD*)cpu)->CSR[321ULL] = epc;
etiss_coverage_count(3, 807, 805, 806);
*((RV32IMACFD*)cpu)->CSR[322ULL] = mcause;
etiss_coverage_count(3, 812, 810, 811);
etiss_uint32 s = RV32IMACFD_csr_read(cpu, system, plugin_pointers, 256ULL);
etiss_coverage_count(2, 816, 815);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 32ULL, RV32IMACFD_get_field(s, 2ULL)));
etiss_coverage_count(7, 826, 817, 825, 823, 818, 822, 820);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 256ULL, ((RV32IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 834, 827, 833, 831, 828, 830);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 2ULL, 0LL));
etiss_coverage_count(6, 842, 835, 841, 839, 836, 838);
RV32IMACFD_csr_write(cpu, system, plugin_pointers, 256ULL, s);
...
vector = ((*((RV32IMACFD*)cpu)->CSR[773ULL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
etiss_coverage_count(13, 866, 852, 865, 860, 857, 855, 856, 858, 859, 863, 861, 862, 864);
cpu->nextPc = (*((RV32IMACFD*)cpu)->CSR[773ULL] & -2LL) + vector;
etiss_coverage_count(7, 879, 867, 878, 875, 870, 876, 877);
*((RV32IMACFD*)cpu)->CSR[833ULL] = epc;
etiss_coverage_count(3, 884, 882, 883);
*((RV32IMACFD*)cpu)->CSR[834ULL] = mcause;
etiss_coverage_count(3, 889, 887, 888);
etiss_uint32 s = RV32IMACFD_csr_read(cpu, system, plugin_pointers, 768ULL);
etiss_coverage_count(2, 893, 892);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 128ULL, RV32IMACFD_get_field(s, 8ULL)));
etiss_coverage_count(7, 903, 894, 902, 900, 895, 899, 897);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 6144ULL, ((RV32IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 911, 904, 910, 908, 905, 907);
s = (etiss_uint32)(RV32IMACFD_set_field(s, 8ULL, 0LL));
etiss_coverage_count(6, 919, 912, 918, 916, 913, 915);
RV32IMACFD_csr_write(cpu, system, plugin_pointers, 768ULL, s);
...
etiss_uint32 pending_interrupts = *((RV32IMACFD*)cpu)->CSR[772ULL] & *((RV32IMACFD*)cpu)->CSR[836ULL];
...
etiss_uint32 mie = (etiss_uint32)(RV32IMACFD_get_field(*((RV32IMACFD*)cpu)->CSR[768ULL], 8ULL));
etiss_coverage_count(4, 1009, 1008, 1006, 1004);
etiss_uint32 m_enabled = ((RV32IMACFD*)cpu)->PRIV < 3ULL || (((RV32IMACFD*)cpu)->PRIV == 3ULL && mie);
etiss_coverage_count(9, 1021, 1020, 1013, 1011, 1018, 1016, 1014, 1017, 1019);
etiss_uint32 enabled_interrupts = pending_interrupts & ~(*((RV32IMACFD*)cpu)->CSR[771ULL]) & -(m_enabled);
...
etiss_uint32 deleg = *((RV32IMACFD*)cpu)->CSR[771ULL];
etiss_coverage_count(2, 1041, 1040);
etiss_uint32 sie = (etiss_uint32)(RV32IMACFD_get_field(RV32IMACFD_csr_read(cpu, system, plugin_pointers, 256ULL), 2ULL));
etiss_coverage_count(4, 1049, 1048, 1046, 1044);
etiss_uint32 s_enabled = ((RV32IMACFD*)cpu)->PRIV < 1ULL || (((RV32IMACFD*)cpu)->PRIV == 1ULL && sie);
