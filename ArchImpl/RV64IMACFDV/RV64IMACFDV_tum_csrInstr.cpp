...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 xrs1 = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
if ((rd % 32ULL) != 0LL) { // conditional
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 xrd = RV64IMACFDV_csr_read(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL);\n";
cp.code() += "RV64IMACFDV_csr_write(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL, xrs1);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = xrd;\n";
cp.code() += "} // block\n";
} // block
} // conditional
else { // conditional
...
cp.code() += "RV64IMACFDV_csr_write(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL, xrd | xrs1);\n";
} // conditional
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = xrd;\n";
} // conditional
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 xrd = RV64IMACFDV_csr_read(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL);\n";
cp.code() += "RV64IMACFDV_csr_write(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL, " + std::to_string((etiss_uint64)(zimm)) + "ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = xrd;\n";
} // conditional
cp.code() += "} // block\n";
...
cp.code() += "RV64IMACFDV_csr_write(cpu, system, plugin_pointers, " + std::to_string(csr) + "ULL, xrd | " + std::to_string((etiss_uint64)(zimm)) + "ULL);\n";
} // conditional
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = xrd;\n";
} // conditional
