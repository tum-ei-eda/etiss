...
if (imm) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd + 8ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[2ULL] + " + std::to_string(imm) + "ULL;\n";
} // conditional
else { // conditional
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_raise(cpu, system, plugin_pointers, 0LL, 2LL);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 load_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
...
cp.code() += "} // conditional\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd + 8ULL) + "ULL] = (etiss_int32)(mem_val_0);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_uint64 load_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 + 8ULL) + "ULL]);\n";
...
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int8)(((etiss_int8)imm) << (2)) >> (2))) + "LL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string(((etiss_int8)(((etiss_int8)imm) << (2)) >> (2))) + "LL;\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string(((etiss_int32)(((etiss_int32)imm) << (14)) >> (14))) + "LL;\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
cp.code() += "*((RV64IMACFDV*)cpu)->X[2ULL] = *((RV64IMACFDV*)cpu)->X[2ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)nzimm) << (6)) >> (6))) + "LL;\n";
} // conditional
else { // conditional
{ // procedure
cp.code() += "{ // procedure\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] >> " + std::to_string(shamt) + "ULL;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] = ((etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL])) >> " + std::to_string(shamt) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] & " + std::to_string(((etiss_int8)(((etiss_int8)imm) << (2)) >> (2))) + "LL;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd + 8ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rd + 8ULL) + "ULL] - *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 + 8ULL) + "ULL];\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "if (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] == 0LL) { // conditional\n";
...
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] << " + std::to_string(nzuimm) + "ULL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "cpu->exception |= (*(system->dread))(system->handle, cpu, *((RV64IMACFDV*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_translate_exc_code(cpu, system, plugin_pointers, cpu->exception);\n";
...
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(res);\n";
cp.code() += "} // block\n";
} // block
} // conditional
else { // conditional
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL];\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if (rs1) { // conditional
cp.code() += "cpu->nextPc = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] & -2LL;\n";
} // conditional
else { // conditional
{ // procedure
cp.code() += "{ // procedure\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] + *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL];\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 new_pc = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[1ULL] = " + std::to_string(ic.current_address_ + 2ULL) + "ULL;\n";
...
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_raise(cpu, system, plugin_pointers, 0LL, 3LL);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
cp.code() += "} // procedure\n";
} // procedure
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFDV*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
