...
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string((etiss_uint64)(((etiss_int32)(imm)))) + "ULL;\n";
} // conditional
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string(ic.current_address_ + (etiss_int32)(imm)) + "LL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_raise(cpu, system, plugin_pointers, 0LL, 0LL);\n";
...
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string(ic.current_address_ + 4ULL) + "ULL;\n";
} // conditional
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 new_pc = (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL) & -2LL;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] == *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
if (imm % 2ULL) { // conditional
{ // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if ((etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) < (etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL])) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
if (imm % 2ULL) { // conditional
{ // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 load_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint64)(res);\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 store_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint8 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int8)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
...
cp.code() += "etiss_uint64 store_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint16 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int16)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
...
cp.code() += "etiss_uint64 store_address = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (((etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) < " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL)) ? (1ULL) : (0LL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] < " + std::to_string((etiss_uint64)((((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))))) + "ULL)) ? (1ULL) : (0LL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] ^ " + std::to_string((etiss_uint64)((((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))))) + "ULL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] << " + std::to_string(shamt) + "ULL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) >> " + std::to_string(shamt) + "ULL;\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL];\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] << (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] & 63ULL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) < (etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL])) ? (1ULL) : (0LL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] < *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]) ? (1ULL) : (0LL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) >> (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] & 63ULL);\n";
} // conditional
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "((RV64IMACFDV*)cpu)->FENCE[0ULL] = " + std::to_string(pred << 4ULL | succ) + "ULL;\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getAffectedRegisters().add("instructionPointer", 32);
