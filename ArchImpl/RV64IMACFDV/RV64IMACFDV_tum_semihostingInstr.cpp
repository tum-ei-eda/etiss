...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 operation = *((RV64IMACFDV*)cpu)->X[10ULL];\n";
cp.code() += "etiss_uint64 parameter = *((RV64IMACFDV*)cpu)->X[11ULL];\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[10ULL] = (etiss_int64)(etiss_semihost(cpu, system, plugin_pointers, 64ULL, operation, parameter));\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // conditional\n";
