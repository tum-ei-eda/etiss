...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint64 mem_val_0;\n";
cp.code() += "cpu->exception |= (*(system->dread))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 8);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_translate_exc_code(cpu, system, plugin_pointers, cpu->exception);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
cp.code() += "} // procedure\n";
} // procedure
cp.code() += "} // conditional\n";
cp.code() += "etiss_uint64 res = (etiss_uint64)(mem_val_0);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
...
cp.code() += "etiss_uint64 offs = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint64 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs3) + "ULL]), 0LL, RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs3) + "ULL]), 1ULL, RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs3) + "ULL]), 2ULL, RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs3) + "ULL]), 3ULL, RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fadd_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fsub_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fmul_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fdiv_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fsqrt_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), RV64IMACFDV_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = ((((((*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]) >> (63ULL)) & 1ULL)) << 63) | ((((*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]) >> (0LL)) & 9223372036854775807ULL)));\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]) ^ ((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]) & 9223372036854775808ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fsel_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), 0LL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fsel_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), (etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL]), 1ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fconv_d2f(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], " + std::to_string(rm) + "ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL + res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fconv_f2d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), " + std::to_string(rm) + "ULL);\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
...
cp.code() += "res = fcmp_d(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL], 0LL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = 0LL;\n";
cp.code() += "res = fcmp_d(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL], 2ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = 0LL;\n";
cp.code() += "res = fcmp_d(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV64IMACFDV*)cpu)->F[" + std::to_string(rs2) + "ULL], 1ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = fclass_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]));\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "res = fcvt_64_32(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], 0LL, " + std::to_string(rm) + "ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
cp.code() += "res = fcvt_64_32(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL], 1ULL, " + std::to_string(rm) + "ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint64)((etiss_int32)(res));\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int64 res = fcvt_32_64((etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 2ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fcvt_32_64((etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 3ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
