...
cp.code() += "((RV64IMACFDV*)cpu)->RES_ADDR = offs;\n";
if (rd) { // conditional
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "if (((RV64IMACFDV*)cpu)->RES_ADDR == offs) { // conditional\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
...
cp.code() += "} // conditional\n";
if (rd) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV64IMACFDV*)cpu)->RES_ADDR != offs;\n";
} // conditional
cp.code() += "((RV64IMACFDV*)cpu)->RES_ADDR = -1LL;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
