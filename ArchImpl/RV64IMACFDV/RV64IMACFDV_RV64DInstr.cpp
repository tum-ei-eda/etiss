...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = fcvt_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), 0LL, " + std::to_string(rm) + "ULL);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = fcvt_d((etiss_uint64)(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), 1ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV64IMACFDV*)cpu)->FCSR = (((RV64IMACFDV*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fcvt_d(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL], 2ULL, " + std::to_string(rm) + "ULL);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fcvt_d(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL], 3ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL];\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
