 ...
 * instruction set for the RV64IMACFDV core architecture.
 */
...
cp.code() += "etiss_uint32 vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "if (lmul & 4ULL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "_illmask = 9223372036854775808ULL;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "_avl = *((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1) + "ULL];\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "_avl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
cp.code() += "} // conditional\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[3104ULL] = _vl;\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[3105ULL] = _illmask | " + std::to_string(zimm) + "ULL;\n";
if (rd != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd) + "ULL] = _vl;\n";
} // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = 0LL;\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint16 zimm = (*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs2) + "ULL]) & 0x7ff;\n";
...
cp.code() += "etiss_uint64 _vlmax = 0LL;\n";
cp.code() += "etiss_uint64 _illmask = 0LL;\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "if (lmul & 4ULL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "_illmask = 9223372036854775808ULL;\n";
...
cp.code() += "} // conditional\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[3104ULL] = _vl;\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[3105ULL] = _illmask | zimm;\n";
if (rd != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd) + "ULL] = _vl;\n";
} // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = 0LL;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 _vstart = *((RV64IMACFDV*)cpu)->CSR[8ULL];\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 _vtype = *((RV64IMACFDV*)cpu)->CSR[3105ULL];\n";
cp.code() += "etiss_uint64 _eew = vcfg_concatEEW(0LL, 0LL);\n";
cp.code() += "etiss_uint64 _vstart = *((RV64IMACFDV*)cpu)->CSR[8ULL];\n";
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = etiss_vload_encoded_unitstride(cpu, system, plugin_pointers, ((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vd) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV64IMACFDV_raise(cpu, system, plugin_pointers, 0LL, 2ULL);\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 _vtype = *((RV64IMACFDV*)cpu)->CSR[3105ULL];\n";
cp.code() += "etiss_uint64 _eew = vcfg_concatEEW(0LL, 5ULL);\n";
cp.code() += "etiss_uint64 _vstart = *((RV64IMACFDV*)cpu)->CSR[8ULL];\n";
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = etiss_vload_encoded_unitstride(cpu, system, plugin_pointers, ((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vd) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 _vtype = *((RV64IMACFDV*)cpu)->CSR[3105ULL];\n";
cp.code() += "etiss_uint64 _eew = vcfg_concatEEW(0LL, 6ULL);\n";
cp.code() += "etiss_uint64 _vstart = *((RV64IMACFDV*)cpu)->CSR[8ULL];\n";
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = etiss_vload_encoded_unitstride(cpu, system, plugin_pointers, ((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vd) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = etiss_vstore_encoded_unitstride(cpu, system, plugin_pointers, ((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vs3) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vadd_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vadd_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vadd_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsub_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsub_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwaddu_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwaddu_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsubu_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsubu_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwadd_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwadd_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsub_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsub_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwaddu_w_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwaddu_w_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwadd_w_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwadd_w_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsubu_w_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsubu_w_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsub_w_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vwsub_w_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vand_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vand_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vand_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vor_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vor_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vor_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vxor_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vxor_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vxor_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsll_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsll_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(uimm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsll_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsrl_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsrl_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(uimm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsrl_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsra_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsra_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(uimm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vsra_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmseq_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmseq_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmseq_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsne_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsne_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsne_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsltu_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsltu_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmslt_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmslt_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsleu_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsleu_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsleu_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(uimm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsle_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, " + std::to_string(vs2) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsle_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsle_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsgtu_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmsgt_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmv_vv(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vd) + "ULL, " + std::to_string(vs1) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmv_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vd) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmv_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vd) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 ret = vmv_xs(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(rd) + "ULL, " + std::to_string(vs2) + "ULL, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vmv_sx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vd) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslideup_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslideup_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslidedown_vi(((RV64IMACFDV*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(simm5) + "ULL, _vstart, _vlen, _vl);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslidedown_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslide1up_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
...
cp.code() += "etiss_uint64 _vl = *((RV64IMACFDV*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint64 _vlen = *((RV64IMACFDV*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint64 ret = vslide1down_vx(((RV64IMACFDV*)cpu)->V, *((RV64IMACFDV*)cpu)->X, _vtype, " + std::to_string(vm) + "ULL, " + std::to_string(vd) + "ULL, " + std::to_string(vs2) + "ULL, " + std::to_string(rs1) + "ULL, _vstart, _vlen, _vl, 64ULL);\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
