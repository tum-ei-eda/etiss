...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int64 res = fcvt_32_64(unbox_s(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), 0LL, " + std::to_string(rm) + "ULL);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 res = fcvt_32_64(unbox_s(*((RV64IMACFDV*)cpu)->F[" + std::to_string(rs1) + "ULL]), 1ULL, " + std::to_string(rm) + "ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV64IMACFDV*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fcvt_64_32(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL], 2ULL, " + std::to_string(rm) + "ULL);\n";
{ // block
cp.code() += "{ // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fcvt_64_32(*((RV64IMACFDV*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL], 3ULL, " + std::to_string(rm) + "ULL);\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFDV*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
