 ...
 *
 * This file contains the GDBCore adapter for the RV32IMXCoreV core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_RV32IMXCoreVArch_RV32IMXCoreVGDBCORE_H_
#define ETISS_RV32IMXCoreVArch_RV32IMXCoreVGDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
    @brief This class is the brige between RV32IMXCoreV architecture and gdbserver

    @details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
                The index in mapRegister() should strictly follow the RV32IMXCoreV gdb tool defined register
                ...
                virtualStruct in RV32IMXCoreVArch.cpp should be modified as well as well

*/
class RV32IMXCoreVGDBCore : public etiss::plugin::gdb::GDBCore
{
  public:
    ...
    bool isLittleEndian()
    {
        // Modify according to RV32IMXCoreV manual
        return true;
    }
};
