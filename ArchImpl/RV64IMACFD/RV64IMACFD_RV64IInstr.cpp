...
cp.code() += "etiss_coverage_count(5, 7497, 7494, 7492, 7495, 7496);\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7534, 7531, 7529, 7532, 7533);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint64)(res);\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7576, 7573, 7571, 7574, 7575);\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7596, 7593, 7591, 7594, 7595);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] >> " + std::to_string(shamt) + "ULL;\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7616, 7613, 7611, 7614, 7615);\n";
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7638, 7635, 7633, 7636, 7637);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7666, 7663, 7661, 7664, 7665);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7697, 7694, 7692, 7695, 7696);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7728, 7725, 7723, 7726, 7727);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7758, 7755, 7753, 7756, 7757);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7793, 7790, 7788, 7791, 7792);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7828, 7825, 7823, 7826, 7827);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7869, 7866, 7864, 7867, 7868);\n";
{ // block
...
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7910, 7907, 7905, 7908, 7909);\n";
{ // block
