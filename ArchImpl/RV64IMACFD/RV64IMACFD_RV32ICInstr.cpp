...
if (imm) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd + 8U) + "] = *((RV64IMACFD*)cpu)->X[2U] + " + std::to_string(imm) + ";\n";
} else {
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if ((rs1 % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32) + "] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "] + " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string(((etiss_int32)((imm) << (14)) >> (14))) + ";\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if (nzimm) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[2U] = *((RV64IMACFD*)cpu)->X[2U] + " + std::to_string(((etiss_int16)((nzimm) << (6)) >> (6))) + ";\n";
} else {
partInit.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		...
		partInit.getRegisterDependencies().add(reg_name[2U], 64);
		partInit.getAffectedRegisters().add(reg_name[2U], 64);
		partInit.getAffectedRegisters().add("instructionPointer", 32);
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if (nzuimm) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32) + "] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "] << " + std::to_string(nzuimm) + ";\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32U) + "];\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if (rs1) {
partInit.code() += "cpu->nextPc = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "] & -2L;\n";
} else {
partInit.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "] + *((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32U) + "];\n";
}
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------

		partInit.getRegisterDependencies().add(reg_name[rd % 32U], 64);
		partInit.getRegisterDependencies().add(reg_name[rs2 % 32U], 64);
		partInit.getAffectedRegisters().add(reg_name[rd % 32], 64);
		partInit.getAffectedRegisters().add("instructionPointer", 32);
...
// -----------------------------------------------------------------------------
		...
		partInit.getRegisterDependencies().add(reg_name[rs1 % 32U], 64);
		partInit.getAffectedRegisters().add(reg_name[1U], 64);
		partInit.getAffectedRegisters().add("instructionPointer", 32);
