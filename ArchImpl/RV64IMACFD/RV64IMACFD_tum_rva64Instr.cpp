...
{ // block
cp.code() += "etiss_coverage_count(1, 9353);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(4, 9328, 9327, 9326, 9324);\n";
...
cp.code() += "etiss_coverage_count(6, 9338, 9337, 9335, 9333, 9331, 9332);\n";
cp.code() += "((RV64IMACFD*)cpu)->RES_ADDR = offs;\n";
cp.code() += "etiss_coverage_count(3, 9341, 9339, 9340);\n";
cp.code() += "etiss_coverage_count(1, 9342);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 9343);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(res);\n";
cp.code() += "etiss_coverage_count(6, 9352, 9348, 9347, 9345, 9351, 9349);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(4, 9360, 9359, 9358, 9356);\n";
cp.code() += "etiss_coverage_count(1, 9361);\n";
cp.code() += "if (((RV64IMACFD*)cpu)->RES_ADDR == offs) { // conditional\n";
cp.code() += "etiss_coverage_count(3, 9364, 9362, 9363);\n";
cp.code() += "etiss_uint64 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(9, 9378, 9370, 9368, 9366, 9367, 9377, 9375, 9374, 9372);\n";
...
cp.code() += "} // conditional\n";
cp.code() += "} // conditional\n";
cp.code() += "etiss_coverage_count(1, 9379);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 9380);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint64)((etiss_uint8)((((RV64IMACFD*)cpu)->RES_ADDR != offs)));\n";
cp.code() += "etiss_coverage_count(10, 9394, 9385, 9384, 9382, 9393, 9391, 9388, 9386, 9387, 9389);\n";
} // conditional
cp.code() += "((RV64IMACFD*)cpu)->RES_ADDR = -1ULL;\n";
cp.code() += "etiss_coverage_count(2, 9402, 9395);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
