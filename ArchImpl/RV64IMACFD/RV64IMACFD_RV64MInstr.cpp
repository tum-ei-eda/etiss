...
{ // block
cp.code() += "etiss_coverage_count(1, 8007);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 7973);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 7979, 7976, 7974, 7977, 7978);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8006);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(16, 8005, 7984, 7983, 7981, 8004, 8002, 7999, 7991, 7989, 7988, 7986, 7998, 7996, 7995, 7993, 8000);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 8300);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 8241);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 8247, 8244, 8242, 8245, 8246);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8299);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 8248);\n";
cp.code() += "if ((etiss_uint32)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]) != 0LL) { // conditional\n";
cp.code() += "etiss_coverage_count(6, 8257, 8255, 8253, 8252, 8250, 8256);\n";
...
cp.code() += "etiss_coverage_count(16, 8282, 8262, 8261, 8259, 8281, 8279, 8277, 8269, 8267, 8266, 8264, 8276, 8274, 8273, 8271, 8278);\n";
cp.code() += "} // conditional\n";
...
cp.code() += "etiss_coverage_count(10, 8298, 8287, 8286, 8284, 8297, 8294, 8292, 8291, 8289, 8295);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
