/**
 * Generated on Tue, 11 Aug 2026 12:31:35 +0000.
 *
...
return (*((RV64IMACFD*)cpu)->CSR[769ULL] >> (extension - 65ULL)) & 1ULL;
...
if ((RV64IMACFD_get_field(*((RV64IMACFD*)cpu)->CSR[384ULL], 17293822569102704640ULL))) { // conditional
etiss_coverage_count(3, 340, 336, 342);
mask = mask | 262144ULL;
...
return *((RV64IMACFD*)cpu)->CSR[3ULL] & 31ULL;
...
return (*((RV64IMACFD*)cpu)->CSR[3ULL] >> 5ULL) & 7ULL;
...
return *((RV64IMACFD*)cpu)->CSR[768ULL] | 8589934592ULL | 34359738368ULL;
...
return (((2ULL) << 62) | (((*((RV64IMACFD*)cpu)->CSR[769ULL]) & 0x3fffffffffffffffULL)));
...
*((RV64IMACFD*)cpu)->CSR[3ULL] = (*((RV64IMACFD*)cpu)->CSR[3ULL] & 224ULL) | (val & 31ULL);
...
*((RV64IMACFD*)cpu)->CSR[3ULL] = ((val & 7ULL) << 5ULL) | (*((RV64IMACFD*)cpu)->CSR[3ULL] & 31ULL);
...
deleg = ((((RV64IMACFD*)cpu)->PRIV <= 1ULL)) ? (*((RV64IMACFD*)cpu)->CSR[771ULL]) : (0LL);
...
deleg = ((((RV64IMACFD*)cpu)->PRIV <= 1ULL)) ? (*((RV64IMACFD*)cpu)->CSR[770ULL]) : (0LL);
etiss_coverage_count(8, 762, 752, 761, 755, 753, 756, 759, 760);
} // block
} // conditional
etiss_coverage_count(1, 764);
if (((RV64IMACFD*)cpu)->PRIV <= 1ULL && (deleg >> bit) & 1ULL) { // conditional
etiss_coverage_count(9, 774, 767, 765, 773, 770, 768, 769, 771, 772);
{ // block
etiss_coverage_count(1, 851);
vector = ((*((RV64IMACFD*)cpu)->CSR[261ULL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
etiss_coverage_count(13, 789, 775, 788, 783, 780, 778, 779, 781, 782, 786, 784, 785, 787);
cpu->nextPc = (*((RV64IMACFD*)cpu)->CSR[261ULL] & -2LL) + vector;
etiss_coverage_count(7, 802, 790, 801, 798, 793, 799, 800);
*((RV64IMACFD*)cpu)->CSR[321ULL] = epc;
etiss_coverage_count(3, 807, 805, 806);
*((RV64IMACFD*)cpu)->CSR[322ULL] = mcause;
etiss_coverage_count(3, 812, 810, 811);
etiss_uint64 s = RV64IMACFD_csr_read(cpu, system, plugin_pointers, 256ULL);
etiss_coverage_count(2, 816, 815);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 32ULL, RV64IMACFD_get_field(s, 2ULL)));
etiss_coverage_count(7, 826, 817, 825, 823, 818, 822, 820);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 256ULL, ((RV64IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 834, 827, 833, 831, 828, 830);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 2ULL, 0LL));
etiss_coverage_count(6, 842, 835, 841, 839, 836, 838);
RV64IMACFD_csr_write(cpu, system, plugin_pointers, 256ULL, s);
etiss_coverage_count(2, 845, 844);
((RV64IMACFD*)cpu)->PRIV = (1ULL) & 0x7ULL;
...
vector = ((*((RV64IMACFD*)cpu)->CSR[773ULL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
etiss_coverage_count(13, 866, 852, 865, 860, 857, 855, 856, 858, 859, 863, 861, 862, 864);
cpu->nextPc = (*((RV64IMACFD*)cpu)->CSR[773ULL] & -2LL) + vector;
etiss_coverage_count(7, 879, 867, 878, 875, 870, 876, 877);
*((RV64IMACFD*)cpu)->CSR[833ULL] = epc;
etiss_coverage_count(3, 884, 882, 883);
*((RV64IMACFD*)cpu)->CSR[834ULL] = mcause;
etiss_coverage_count(3, 889, 887, 888);
etiss_uint64 s = RV64IMACFD_csr_read(cpu, system, plugin_pointers, 768ULL);
etiss_coverage_count(2, 893, 892);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 128ULL, RV64IMACFD_get_field(s, 8ULL)));
etiss_coverage_count(7, 903, 894, 902, 900, 895, 899, 897);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 6144ULL, ((RV64IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 911, 904, 910, 908, 905, 907);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 8ULL, 0LL));
etiss_coverage_count(6, 919, 912, 918, 916, 913, 915);
RV64IMACFD_csr_write(cpu, system, plugin_pointers, 768ULL, s);
etiss_coverage_count(2, 922, 921);
((RV64IMACFD*)cpu)->PRIV = (3ULL) & 0x7ULL;
...
etiss_uint64 pending_interrupts = *((RV64IMACFD*)cpu)->CSR[772ULL] & *((RV64IMACFD*)cpu)->CSR[836ULL];
...
etiss_uint64 mie = (etiss_uint64)(RV64IMACFD_get_field(*((RV64IMACFD*)cpu)->CSR[768ULL], 8ULL));
etiss_coverage_count(4, 1009, 1008, 1006, 1004);
etiss_uint64 m_enabled = ((RV64IMACFD*)cpu)->PRIV < 3ULL || (((RV64IMACFD*)cpu)->PRIV == 3ULL && mie);
etiss_coverage_count(9, 1021, 1020, 1013, 1011, 1018, 1016, 1014, 1017, 1019);
etiss_uint64 enabled_interrupts = pending_interrupts & ~(*((RV64IMACFD*)cpu)->CSR[771ULL]) & -(m_enabled);
...
etiss_uint64 deleg = *((RV64IMACFD*)cpu)->CSR[771ULL];
etiss_coverage_count(2, 1041, 1040);
etiss_uint64 sie = (etiss_uint64)(RV64IMACFD_get_field(RV64IMACFD_csr_read(cpu, system, plugin_pointers, 256ULL), 2ULL));
etiss_coverage_count(4, 1049, 1048, 1046, 1044);
etiss_uint64 s_enabled = ((RV64IMACFD*)cpu)->PRIV < 1ULL || (((RV64IMACFD*)cpu)->PRIV == 1ULL && sie);
...
etiss_coverage_count(4, 7433, 7430, 7428, 7431);
} // block
}
...
return (etiss_int64)((res >> 64ULL));
etiss_coverage_count(4, 7450, 7447, 7445, 7448);
} // block
}
...
{ // block
etiss_coverage_count(1, 7469);
etiss_uint128 res = (etiss_uint128)(x) * (etiss_uint128)(y);
etiss_coverage_count(6, 7461, 7460, 7456, 7454, 7459, 7457);
etiss_coverage_count(1, 7468);
return (etiss_uint64)((res >> 64ULL));
etiss_coverage_count(4, 7467, 7464, 7462, 7465);
} // block
}
// clang-format on
