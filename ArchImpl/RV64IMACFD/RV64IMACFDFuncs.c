...
s = (etiss_uint64)(RV64IMACFD_set_field(s, 32LL, RV64IMACFD_get_field(s, 2LL)));
etiss_coverage_count(7, 826, 817, 825, 823, 818, 822, 820);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 256LL, ((RV64IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 834, 827, 833, 831, 828, 830);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 2LL, 0LL));
...
s = (etiss_uint64)(RV64IMACFD_set_field(s, 128LL, RV64IMACFD_get_field(s, 8LL)));
etiss_coverage_count(7, 903, 894, 902, 900, 895, 899, 897);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 6144LL, ((RV64IMACFD*)cpu)->PRIV));
etiss_coverage_count(6, 911, 904, 910, 908, 905, 907);
s = (etiss_uint64)(RV64IMACFD_set_field(s, 8LL, 0LL));
...
etiss_uint64 mie = (etiss_uint64)(RV64IMACFD_get_field(*((RV64IMACFD*)cpu)->CSR[768LL], 8LL));
...
etiss_uint64 sie = (etiss_uint64)(RV64IMACFD_get_field(RV64IMACFD_csr_read(cpu, system, plugin_pointers, 256LL), 2LL));
...
{ // block
etiss_coverage_count(1, 7414);
etiss_int128 res = (etiss_int128)(x) * (etiss_int128)(y);
etiss_coverage_count(6, 7406, 7405, 7401, 7399, 7404, 7402);
etiss_coverage_count(1, 7413);
return (etiss_int64)((res >> 64ULL));
etiss_coverage_count(4, 7412, 7409, 7407, 7410);
} // block
}
...
{ // block
etiss_coverage_count(1, 7431);
etiss_int128 res = (etiss_int128)(x) * (etiss_uint128)(y);
etiss_coverage_count(6, 7423, 7422, 7418, 7416, 7421, 7419);
etiss_coverage_count(1, 7430);
return (etiss_int64)((res >> 64ULL));
etiss_coverage_count(4, 7429, 7426, 7424, 7427);
} // block
}
...
{ // block
etiss_coverage_count(1, 7448);
etiss_uint128 res = (etiss_uint128)(x) * (etiss_uint128)(y);
etiss_coverage_count(6, 7440, 7439, 7435, 7433, 7438, 7436);
etiss_coverage_count(1, 7447);
return (etiss_uint64)((res >> 64ULL));
etiss_coverage_count(4, 7446, 7443, 7441, 7444);
} // block
}
// clang-format on
