...
cp.code() += "etiss_coverage_count(3, 8621, 8612, 8620);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = " + std::to_string(MMIN) + "ULL;\n";
cp.code() += "etiss_coverage_count(3, 8628, 8626, 8627);\n";
cp.code() += "} // conditional\n";
...
cp.code() += "etiss_coverage_count(3, 8647, 8633, 8646);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // conditional\n";
...
cp.code() += "etiss_coverage_count(2, 8656, 8654);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
{ // block
cp.code() += "etiss_coverage_count(1, 8699);\n";
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "etiss_coverage_count(2, 8665, 8664);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8697);\n";
cp.code() += "{ // block\n";
cp.code() += "if (*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] != 0ULL) { // conditional\n";
cp.code() += "etiss_coverage_count(2, 8671, 8670);\n";
...
cp.code() += "etiss_coverage_count(3, 8688, 8676, 8687);\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = -1LL;\n";
cp.code() += "etiss_coverage_count(2, 8695, 8693);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
{ // block
cp.code() += "etiss_coverage_count(1, 8774);\n";
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "etiss_coverage_count(2, 8704, 8703);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8772);\n";
cp.code() += "{ // block\n";
cp.code() += "if (*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] != 0ULL) { // conditional\n";
cp.code() += "etiss_coverage_count(2, 8710, 8709);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8759);\n";
cp.code() += "{ // block\n";
etiss_uint64 MMIN = 9223372036854775808ULL;
cp.code() += "etiss_coverage_count(1, 8716);\n";
cp.code() += "if (*((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] == " + std::to_string(MMIN) + "ULL && (etiss_int64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]) == -1LL) { // conditional\n";
cp.code() += "etiss_coverage_count(3, 8732, 8723, 8731);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = 0ULL;\n";
cp.code() += "etiss_coverage_count(2, 8738, 8737);\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]) % (etiss_int64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(3, 8757, 8743, 8756);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // conditional\n";
...
cp.code() += "etiss_coverage_count(3, 8770, 8764, 8769);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
{ // block
cp.code() += "etiss_coverage_count(1, 8817);\n";
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "etiss_coverage_count(2, 8779, 8778);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 8815);\n";
cp.code() += "{ // block\n";
cp.code() += "if (*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] != 0ULL) { // conditional\n";
cp.code() += "etiss_coverage_count(2, 8785, 8784);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] % *((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(3, 8802, 8790, 8801);\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(3, 8813, 8807, 8812);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
