...
{ // block
cp.code() += "etiss_coverage_count(1, 3104);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 3060);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "etiss_coverage_count(5, 3066, 3063, 3061, 3064, 3065);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 3103);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_coverage_count(1, 3067);\n";
cp.code() += "if (*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL] != 0LL) { // conditional\n";
cp.code() += "etiss_coverage_count(5, 3074, 3072, 3071, 3069, 3073);\n";
...
cp.code() += "etiss_coverage_count(11, 3091, 3079, 3078, 3076, 3090, 3084, 3083, 3081, 3089, 3088, 3086);\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(7, 3102, 3096, 3095, 3093, 3101, 3100, 3098);\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
