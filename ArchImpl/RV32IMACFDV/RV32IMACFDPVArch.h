...
#ifndef ETISS_RV32IMACFDPVArch_RV32IMACFDPVArch_H_
#define ETISS_RV32IMACFDPVArch_RV32IMACFDPVArch_H_
...
#include "RV32IMACFDPVGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACFDPV;
extern etiss::instr::InstructionClass ISA16_RV32IMACFDPVClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMACFDPV;
extern etiss::instr::InstructionClass ISA32_RV32IMACFDPVClass;

extern etiss::instr::InstructionCollection RV32IMACFDPVISA;

class RV32IMACFDPVArch : public etiss::CPUArch {

public:
	RV32IMACFDPVArch(unsigned int);
	...
	/**
		...
		@see RV32IMACFDPVArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACFDPV architecture

		@see RV32IMACFDPVGDBCore.h for implementation of GDBcore
	*/
