 ...
 *
 * This file contains the GDBCore adapter for the XIsaacCore core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_XIsaacCoreArch_XIsaacCoreGDBCORE_H_
#define ETISS_XIsaacCoreArch_XIsaacCoreGDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between XIsaacCore architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the XIsaacCore gdb tool defined register
				...
				virtualStruct in XIsaacCoreArch.cpp should be modified as well as well

*/
class XIsaacCoreGDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to XIsaacCore manual
		return true;
	}
};
