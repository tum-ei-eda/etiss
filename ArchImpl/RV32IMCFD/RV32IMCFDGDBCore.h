 ...
 *
 * This file contains the GDBCore adapter for the RV32IMCFD core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_RV32IMCFDArch_RV32IMCFDGDBCORE_H_
#define ETISS_RV32IMCFDArch_RV32IMCFDGDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between RV32IMCFD architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the RV32IMCFD gdb tool defined register
				...
				virtualStruct in RV32IMCFDArch.cpp should be modified as well as well

*/
class RV32IMCFDGDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to RV32IMCFD manual
		return true;
	}
};
