...
partInit.code() += "if (!((*((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(768U) + "] & 1536U))) {\n";
...
partInit.code() += "etiss_uint32 vlen = *((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(3106U) + "] * 8U;\n";
partInit.code() += "if (lmul & 4U) {\n";
partInit.code() += "etiss_uint32 _illmask = 2147483648U;\n";
partInit.code() += "if (lmul == 6U) {\n";
partInit.code() += "etiss_uint32 _vlmax = vlen / (8U << sew) / 4U;\n";
partInit.code() += "}\n";partInit.code() += " else if (lmul == 7U) {\n";
partInit.code() += "etiss_uint32 _vlmax = vlen / (8U << sew) / 2U;\n";
partInit.code() += "}\n";
partInit.code() += " else {\n";
partInit.code() += "etiss_uint32 _vlmax = vlen / (8U << sew) / 8U;\n";
partInit.code() += "}\n";
partInit.code() += "}\n";
partInit.code() += " else {\n";
partInit.code() += "etiss_uint32 _illmask = 0U;\n";
partInit.code() += "if (lmul == 0U) {\n";
partInit.code() += "etiss_uint32 _vlmax = vlen / (8U << sew);\n";
...
partInit.code() += "etiss_uint32 _illmask = 2147483648U;\n";
partInit.code() += "if (lmul == 6U) {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew) / 4U;\n";
partInit.code() += "}\n";partInit.code() += " else if (lmul == 7U) {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew) / 2U;\n";
partInit.code() += "}\n";
partInit.code() += " else {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew) / 8U;\n";
partInit.code() += "}\n";
partInit.code() += "}\n";
partInit.code() += " else {\n";
partInit.code() += "etiss_uint32 _illmask = 0U;\n";
partInit.code() += "if (lmul == 0U) {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew);\n";
partInit.code() += "}\n";partInit.code() += " else if (lmul == 1U) {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew) * 2U;\n";
partInit.code() += "}\n";partInit.code() += " else if (lmul == 2U) {\n";
partInit.code() += "etiss_uint32 _vlmax = _vlen / (8U << sew) * 4U;\n";
...
// -----------------------------------------------------------------------------
		...
		partInit.code() = std::string("//VLE_U\n");
...
partInit.code() += "etiss_uint32 _vlen = *((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(3106U) + "] * 8U;\n";
partInit.code() += "etiss_uint32 ret = etiss_vload_encoded_unitstride(cpu, system, plugin_pointers, ((RV32IMACFDPV*)cpu)->V, _vtype, " + std::to_string(vm) + ", _eew, " + std::to_string(vd) + ", _vstart, _vlen, _vl, *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1) + "]);\n";
...
// -----------------------------------------------------------------------------
		...
		std::stringstream ss;
// -----------------------------------------------------------------------------
ss << "vle_u" << " # " << ba << (" [vd=" + std::to_string(vd) + " | width=" + std::to_string(width) + " | rs1=" + std::to_string(rs1) + " | vm=" + std::to_string(vm) + " | mew=" + std::to_string(mew) + "]");
// -----------------------------------------------------------------------------
		return ss.str();
	}
);
...
// -----------------------------------------------------------------------------
		...
		partInit.code() = std::string("//VSE_U\n");
...
partInit.code() += "etiss_uint32 _vl = *((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(3104U) + "];\n";
partInit.code() += "etiss_uint32 _vlen = *((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(3106U) + "] * 8U;\n";
partInit.code() += "etiss_uint32 ret = etiss_vstore_encoded_unitstride(cpu, system, plugin_pointers, ((RV32IMACFDPV*)cpu)->V, _vtype, " + std::to_string(vm) + ", _eew, " + std::to_string(vs3) + ", _vstart, _vlen, _vl, *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1) + "]);\n";
partInit.code() += "if (ret != 0U) {\n";
partInit.code() += "*((RV32IMACFDPV*)cpu)->CSR[" + std::to_string(8) + "] = ret >> 8U;\n";
partInit.code() += "exception = ETISS_RETURNCODE_ILLEGALINSTRUCTION;\n";
partInit.code() += "}\n";
...
// -----------------------------------------------------------------------------
		...
		std::stringstream ss;
// -----------------------------------------------------------------------------
ss << "vse_u" << " # " << ba << (" [vs3=" + std::to_string(vs3) + " | width=" + std::to_string(width) + " | rs1=" + std::to_string(rs1) + " | vm=" + std::to_string(vm) + " | mew=" + std::to_string(mew) + "]");
// -----------------------------------------------------------------------------
		return ss.str();
	}
);
