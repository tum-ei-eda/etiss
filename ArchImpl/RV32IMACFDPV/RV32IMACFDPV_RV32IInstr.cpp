...
partInit.code() += "}\n";
partInit.code() += "if (cpu->instructionPointer != " + std::to_string(ic.current_address_ + 4) + ") return ((RV32IMACFDPV*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
