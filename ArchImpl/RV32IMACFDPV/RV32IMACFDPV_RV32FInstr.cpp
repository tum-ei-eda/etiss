...
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "]), 0U, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "]), 1U, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 frs3 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "]);\n";
partInit.code() += "etiss_uint32 res = fmadd_s(frs1, frs2, frs3, 2U, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 frs3 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "]);\n";
partInit.code() += "etiss_uint32 res = fmadd_s(frs1, frs2, frs3, 3U, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 res = fadd_s(frs1, frs2, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 res = fsub_s(frs1, frs2, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 res = fmul_s(frs1, frs2, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "]);\n";
partInit.code() += "etiss_uint32 res = fdiv_s(frs1, frs2, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]);\n";
partInit.code() += "etiss_uint32 res = fsqrt_s(frs1, (" + std::to_string(rm < 7U) + ") ? (" + std::to_string(rm) + ") : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32U) | (flags & 31U);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 res = 0U;\n";
partInit.code() += "res = fclass_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "]));\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32) + "] = res;\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "]), 2U, " + std::to_string(rm) + ");\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "]), 3U, " + std::to_string(rm) + ");\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(res);\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32) + "] = ((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "];\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "] = -4294967296UL | (etiss_uint64)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "]);\n";
// -----------------------------------------------------------------------------
