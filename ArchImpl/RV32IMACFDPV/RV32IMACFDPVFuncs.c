 ...
 *
 * This file contains the function implementations for the RV32IMACFDPV core architecture.
 */
...
{
{ // block
return (*((RV32IMACFDPV*)cpu)->CSR[769LL] >> (extension - 65ULL)) & 1ULL;
} // block
}
...
rm = ((((((RV32IMACFDPV*)cpu)->FCSR) >> (5ULL)) & 7ULL)) & 0x7;
} // conditional
if (rm > 4ULL) { // conditional
RV32IMACFDPV_raise(cpu, system, plugin_pointers, 0LL, 2LL);
} // conditional
return rm;
} // block
}
...
if (RV32IMACFDPV_extension_enabled(cpu, system, plugin_pointers, 83ULL)) { // conditional
{ // block
mask = mask | 5767458ULL;
if (RV32IMACFDPV_extension_enabled(cpu, system, plugin_pointers, 86ULL)) { // conditional
mask = mask | 1536LL;
} // conditional
if (RV32IMACFDPV_extension_enabled(cpu, system, plugin_pointers, 70ULL)) { // conditional
mask = mask | 24576LL;
} // conditional
if (RV32IMACFDPV_extension_enabled(cpu, system, plugin_pointers, 88ULL)) { // conditional
mask = mask | 98304LL;
} // conditional
if ((RV32IMACFDPV_get_field(*((RV32IMACFDPV*)cpu)->CSR[384LL], 2147483648ULL))) { // conditional
mask = mask | 262144LL;
} // conditional
} // block
} // conditional
...
return mask | RV32IMACFDPV_sstatus_mask(cpu, system, plugin_pointers);
} // block
}
...
return *((RV32IMACFDPV*)cpu)->CSR[3LL] & 31ULL;
} // conditional
if (csr == 2LL) { // conditional
return (*((RV32IMACFDPV*)cpu)->CSR[3LL] >> 5ULL) & 7ULL;
} // conditional
...
return *((RV32IMACFDPV*)cpu)->CSR[768LL] | 8589934592ULL | 34359738368ULL;
} // conditional
if (csr == 769LL) { // conditional
return (((1ULL) << 30) | ((((*((RV32IMACFDPV*)cpu)->CSR[769LL]) >> (0LL)) & 1073741823ULL)));
} // conditional
...
{ // block
if (csr == 1LL) { // conditional
*((RV32IMACFDPV*)cpu)->CSR[3LL] = (*((RV32IMACFDPV*)cpu)->CSR[3LL] & 224ULL) | (val & 31ULL);
} // conditional
 else if (csr == 2LL) { // conditional
*((RV32IMACFDPV*)cpu)->CSR[3LL] = ((val & 7ULL) << 5ULL) | (*((RV32IMACFDPV*)cpu)->CSR[3LL] & 31ULL);
} // conditional
 else if (csr == 3LL) { // conditional
*((RV32IMACFDPV*)cpu)->CSR[3LL] = val & 255ULL;
} // conditional
 else if (csr == 768LL) { // conditional
*((RV32IMACFDPV*)cpu)->CSR[768LL] = val & RV32IMACFDPV_mstatus_mask(cpu, system, plugin_pointers);
} // conditional
 else if (csr == 256LL) { // conditional
*((RV32IMACFDPV*)cpu)->CSR[768LL] = val & RV32IMACFDPV_sstatus_mask(cpu, system, plugin_pointers);
} // conditional
...
if (irq2) { // conditional
{ // block
deleg = ((((RV32IMACFDPV*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDPV*)cpu)->CSR[771LL]) : (0LL);
bit = bit & 2147483647ULL;
} // block
} // conditional
else { // conditional
{ // block
deleg = ((((RV32IMACFDPV*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDPV*)cpu)->CSR[770LL]) : (0LL);
} // block
} // conditional
if (((RV32IMACFDPV*)cpu)->PRIV <= 1LL && (deleg >> bit) & 1ULL) { // conditional
{ // block
vector = ((*((RV32IMACFDPV*)cpu)->CSR[261LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
cpu->nextPc = (*((RV32IMACFDPV*)cpu)->CSR[261LL] & -2LL) + vector;
*((RV32IMACFDPV*)cpu)->CSR[321LL] = epc;
*((RV32IMACFDPV*)cpu)->CSR[322LL] = mcause;
etiss_uint32 s = RV32IMACFDPV_csr_read(cpu, system, plugin_pointers, 256LL);
s = RV32IMACFDPV_set_field(s, 32LL, RV32IMACFDPV_get_field(s, 2LL));
s = RV32IMACFDPV_set_field(s, 256LL, ((RV32IMACFDPV*)cpu)->PRIV);
s = RV32IMACFDPV_set_field(s, 2LL, 0LL);
RV32IMACFDPV_csr_write(cpu, system, plugin_pointers, 256LL, s);
((RV32IMACFDPV*)cpu)->PRIV = (1LL) & 0x7;
} // block
} // conditional
else { // conditional
{ // block
vector = ((*((RV32IMACFDPV*)cpu)->CSR[773LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
cpu->nextPc = (*((RV32IMACFDPV*)cpu)->CSR[773LL] & -2LL) + vector;
*((RV32IMACFDPV*)cpu)->CSR[833LL] = epc;
*((RV32IMACFDPV*)cpu)->CSR[834LL] = mcause;
etiss_uint32 s = RV32IMACFDPV_csr_read(cpu, system, plugin_pointers, 768LL);
s = RV32IMACFDPV_set_field(s, 128LL, RV32IMACFDPV_get_field(s, 8LL));
s = RV32IMACFDPV_set_field(s, 6144LL, ((RV32IMACFDPV*)cpu)->PRIV);
s = RV32IMACFDPV_set_field(s, 8LL, 0LL);
RV32IMACFDPV_csr_write(cpu, system, plugin_pointers, 768LL, s);
((RV32IMACFDPV*)cpu)->PRIV = (3LL) & 0x7;
} // block
} // conditional
} // block
}
...
{ // block
code = RV32IMACFDPV_calc_irq_mcause(cpu, system, plugin_pointers);
if (!(code)) { // conditional
return;
} // conditional
} // block
...
RV32IMACFDPV_raise(cpu, system, plugin_pointers, 0LL, code);
} // block
}
...
{
{ // block
etiss_uint32 pending_interrupts = *((RV32IMACFDPV*)cpu)->CSR[772LL] & *((RV32IMACFDPV*)cpu)->CSR[836LL];
if (!(pending_interrupts)) { // conditional
return 0LL;
} // conditional
etiss_uint32 mie = RV32IMACFDPV_get_field(*((RV32IMACFDPV*)cpu)->CSR[768LL], 8LL);
etiss_uint32 m_enabled = ((RV32IMACFDPV*)cpu)->PRIV < 3LL || (((RV32IMACFDPV*)cpu)->PRIV == 3LL && mie);
etiss_uint32 enabled_interrupts = pending_interrupts & ~(*((RV32IMACFDPV*)cpu)->CSR[771LL]) & -(m_enabled);
if (enabled_interrupts == 0LL) { // conditional
{ // block
etiss_uint32 deleg = *((RV32IMACFDPV*)cpu)->CSR[771LL];
etiss_uint32 sie = RV32IMACFDPV_get_field(RV32IMACFDPV_csr_read(cpu, system, plugin_pointers, 256LL), 2LL);
etiss_uint32 s_enabled = ((RV32IMACFDPV*)cpu)->PRIV < 1LL || (((RV32IMACFDPV*)cpu)->PRIV == 1LL && sie);
...
return 2147483648ULL | RV32IMACFDPV_ctz(enabled_interrupts);
} // block
} // conditional
return 0LL;
} // block
...
{
{ // block
etiss_uint32 irq_mcause = RV32IMACFDPV_calc_irq_mcause(cpu, system, plugin_pointers);
if (irq_mcause) { // conditional
RV32IMACFDPV_raise(cpu, system, plugin_pointers, 1ULL, irq_mcause);
} // conditional
} // block
}
